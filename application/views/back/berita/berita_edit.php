          ...
          <div class="col-lg-12">
              ...
              <div class="box-body">
                  ...
                  <div class="form-group"><label>Nama <?php echo $module ?></label>
                    <?php echo form_input($nama_berita, $berita->nama_berita);?>
                  </div>
                  <div class="form-group"><label>Deskripsi</label>
                    <?php echo form_textarea($deskripsi, $berita->deskripsi);?>
                  </div>
                  <div class="form-group"><label>Nama Kategori</label>
										<?php echo form_dropdown('',$ambil_kategori,$berita->kategori,$kat_id);?>
									</div>
                  <div class="form-group"><label>Foto Sebelumnya</label><br>
                    <img src="<?php echo base_url('assets/images/berita/'.$berita->foto.$berita->foto_type.'') ?>" width="200px"/>
                  </div>

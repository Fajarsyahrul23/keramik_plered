...
<!-- Bootstrap JS -->
<script src="<?php echo base_url(); ?>assets/template/frontend/js/jquery-3.3.1.min.js"></script>
<script src="<?php echo base_url(); ?>assets/template/frontend/js/bootstrap.min.js"></script>
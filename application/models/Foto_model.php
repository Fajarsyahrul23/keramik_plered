...
class Foto_model extends CI_Model
{
  ...
  public $id    = 'id_foto';
  public $order = 'DESC';
// nanti ganti jadi asc biar urutan dari lama ke baru 
  function get_all()
  {
    $this->db->select('id_album, id_foto, nama_foto, deskripsi, nama_album, foto.foto as gambar, foto.created_at, foto.created_by, foto.modified_at, foto.modified_by');
